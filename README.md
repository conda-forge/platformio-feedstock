...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/platformio-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/platformio-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install platformio
```
...
It is possible to list all of the versions of `platformio` available on your platform:
...
```
pixi search platformio --channel conda-forge
```
