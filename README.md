...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/platformio-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9248&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/platformio-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `platformio` can be installed with:

```
conda install platformio
```

It is possible to list all of the versions of `platformio` available on your platform with:
